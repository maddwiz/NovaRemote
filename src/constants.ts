...
export const STORAGE_SPATIAL_LAYOUT_PREFIX = "novaremote.spatial_layout.v1";
...
export const NOVA_VOICE_CAPTURE_MS = 5000;
export const NOVA_VOICE_VAD_SILENCE_MS = 900;
