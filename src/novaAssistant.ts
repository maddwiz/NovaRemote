...
export function buildNovaAssistantPrompt(args: {
  ...
  return [
    ...
    "- When the user mentions Desktop, Downloads, Documents, Home, or ~, preserve that location in the action path instead of collapsing it to a bare relative name.",
    ...
    '- {"type":"create_folder","serverRef":"optional","path":"~/Desktop/new-folder"}',
...
export function buildNovaAssistantToolPrompt(args: {
  ...
  return [
    ...
    "- Preserve explicit Desktop, Downloads, Documents, Home, or ~ locations in folder and file paths.",
