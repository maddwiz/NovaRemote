...
export const styles = StyleSheet.create({
  ...
  appTopBar: {
    borderRadius: 20,
    borderWidth: 1,
    borderColor: "rgba(96, 78, 170, 0.42)",
    backgroundColor: "rgba(9, 5, 23, 0.9)",
  ...
  tabButton: {
    borderRadius: 14,
    borderWidth: 1,
    borderColor: "rgba(83, 66, 149, 0.6)",
    backgroundColor: "rgba(16, 10, 37, 0.9)",
    alignItems: "center",
  ...
  tabButtonOn: {
    borderColor: "#37cfff",
    backgroundColor: "rgba(55, 207, 255, 0.18)",
  },
  tabButtonText: {
    color: "#a9d7ff",
    fontSize: 13,
  ...
  navModeButton: {
    borderRadius: 14,
    borderWidth: 1,
    borderColor: "rgba(77, 63, 140, 0.56)",
    backgroundColor: "rgba(18, 12, 38, 0.88)",
    paddingHorizontal: 10,
    paddingVertical: 8,
  },
  navModeButtonText: {
  ...
  bottomQuickNav: {
    ...
    borderRadius: 18,
    borderWidth: 1,
    borderColor: "rgba(86, 67, 153, 0.58)",
    backgroundColor: "rgba(8, 4, 23, 0.96)",
    padding: 9,
    shadowColor: "#130a36",
    shadowOpacity: 0.25,
    shadowRadius: 14,
  ...
  bottomQuickNavButton: {
    ...
    borderRadius: 12,
    borderWidth: 1,
    borderColor: "rgba(86, 67, 153, 0.55)",
    backgroundColor: "rgba(20, 13, 43, 0.86)",
    alignItems: "center",
    justifyContent: "center",
    paddingVertical: 9,
    paddingHorizontal: 6,
  ...
  panel: {
    borderRadius: 20,
    borderWidth: 1,
    borderColor: "rgba(86, 67, 153, 0.45)",
    backgroundColor: "rgba(11, 7, 27, 0.84)",
    padding: 14,
    gap: 11,
    shadowColor: "#110830",
    shadowOpacity: 0.2,
  ...
  serverCard: {
    borderRadius: 16,
    borderWidth: 1,
    borderColor: "rgba(82, 65, 145, 0.52)",
    backgroundColor: "rgba(16, 10, 37, 0.84)",
    padding: 11,
    gap: 8,
  },
  serverCardActive: {
  ...
  input: {
    borderRadius: 14,
    borderWidth: 1,
    borderColor: "rgba(86, 67, 153, 0.48)",
    backgroundColor: "rgba(17, 11, 37, 0.82)",
    color: "#f3ebff",
    paddingHorizontal: 12,
    paddingVertical: 11,
    fontSize: 15,
  ...
  buttonPrimary: {
    ...
    backgroundColor: "rgba(17, 140, 186, 0.9)",
    alignItems: "center",
    justifyContent: "center",
  },
  buttonPrimaryText: {
  ...
  buttonGhost: {
    ...
    paddingVertical: 11,
    paddingHorizontal: 12,
    backgroundColor: "rgba(21, 14, 44, 0.84)",
    alignItems: "center",
    justifyContent: "center",
  },
  buttonGhostText: {
  ...
  modeButton: {
    ...
    borderWidth: 1,
    borderColor: "rgba(86, 67, 153, 0.58)",
    backgroundColor: "rgba(20, 13, 43, 0.82)",
    paddingHorizontal: 12,
    paddingVertical: 6,
  },
  modeButtonOn: {
  ...
  chip: {
    ...
    borderWidth: 1,
    borderColor: "rgba(86, 67, 153, 0.58)",
    backgroundColor: "rgba(20, 13, 43, 0.8)",
    paddingHorizontal: 12,
    paddingVertical: 8,
  },
  chipActive: {
  ...
  terminalCard: {
    ...
    borderWidth: 1,
    borderColor: "rgba(86, 67, 153, 0.48)",
    backgroundColor: "rgba(9, 6, 23, 0.86)",
    padding: 12,
    gap: 8,
    marginBottom: 8,
  },
  ...
  actionButton: {
    ...
    borderWidth: 1,
    borderColor: "rgba(86, 67, 153, 0.55)",
    backgroundColor: "rgba(21, 14, 45, 0.82)",
    paddingHorizontal: 10,
    paddingVertical: 8,
  },
  actionButtonText: {
  ...
  terminalView: {
    borderRadius: 14,
    borderWidth: 1,
    borderColor: "rgba(55, 207, 255, 0.7)",
  ...
  overlayCard: {
    ...
    borderRadius: 20,
    borderWidth: 1,
    borderColor: "rgba(86, 67, 153, 0.5)",
