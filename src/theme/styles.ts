...
export const styles = StyleSheet.create({
  ...
  panel: {
    ...
    borderWidth: 0,
    borderBottomWidth: 1,
    borderColor: "rgba(105, 114, 153, 0.2)",
    backgroundColor: "transparent",
    padding: 6,
    gap: 11,
  },
  ...
  input: {
    borderRadius: 12,
    borderWidth: 1,
    borderColor: "rgba(95, 111, 158, 0.5)",
    backgroundColor: "rgba(20, 26, 46, 0.24)",
    color: "#f3ebff",
    paddingHorizontal: 12,
    paddingVertical: 10,
    fontSize: 15,
  ...
  buttonPrimary: {
    ...
    backgroundColor: "rgba(46, 168, 212, 0.38)",
    alignItems: "center",
    justifyContent: "center",
  },
  buttonPrimaryText: {
  ...
  shellHeaderBar: {
    ...
    borderRadius: 16,
    borderWidth: 1,
    borderColor: "rgba(73, 92, 131, 0.36)",
    backgroundColor: "rgba(8, 12, 25, 0.84)",
    paddingHorizontal: 10,
    paddingVertical: 8,
  },
  shellHeaderMenuButton: {
    borderRadius: 12,
    borderWidth: 1,
    borderColor: "rgba(82, 109, 152, 0.6)",
    backgroundColor: "rgba(21, 28, 49, 0.72)",
    paddingHorizontal: 12,
    paddingVertical: 8,
  },
  shellHeaderMenuText: {
  ...
  homeHubNavCard: {
    ...
    borderRadius: 16,
    borderWidth: 1,
    borderColor: "rgba(79, 102, 145, 0.48)",
    backgroundColor: "rgba(14, 20, 40, 0.75)",
    paddingHorizontal: 12,
    paddingVertical: 14,
    gap: 4,
    minHeight: 88,
  ...
  homeHubLogoShell: {
    ...
    borderRadius: 18,
    borderWidth: 1,
    borderColor: "rgba(83, 103, 148, 0.44)",
  ...
  pageMenuPanel: {
    ...
    maxWidth: 360,
    borderRightWidth: 1,
    borderColor: "rgba(64, 90, 130, 0.72)",
    backgroundColor: "rgba(8, 12, 26, 0.98)",
    paddingHorizontal: 14,
    paddingVertical: 16,
    gap: 12,
  },
