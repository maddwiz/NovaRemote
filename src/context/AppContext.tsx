...
export type TerminalsViewModel = {
  ...
  onQueueAgentCommandForServer: (serverId: string, name: string, command: string) => Promise<string[]>;
  onQueueAgentCommandForServers: (serverIds: string[], name: string, command: string) => Promise<string[]>;
  onApproveReadyAgentsForServer: (serverId: string) => Promise<string[]>;
  onDenyAllPendingAgentsForServer: (serverId: string) => Promise<string[]>;
  onApproveReadyAgentsForServers: (serverIds: string[]) => Promise<string[]>;
  onDenyAllPendingAgentsForServers: (serverIds: string[]) => Promise<string[]>;
