...
- Server-backed NovaAdapt work is now split into:
  ...
  - the remaining phone-side fallback UI is now isolated in `NovaDeviceFallbackPanel`, keeping `NovaAgentPanel` server-first and making future fallback removal lower-risk
